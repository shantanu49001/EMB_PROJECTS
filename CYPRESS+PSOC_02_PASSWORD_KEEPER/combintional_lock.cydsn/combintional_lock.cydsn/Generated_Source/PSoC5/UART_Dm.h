...
void    UART_Dm_SetInterruptMode(uint16 position, uint16 mode);
...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the UART_Dm_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(UART_Dm__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in UART_Dm_SetInterruptMode() function.
     *  @{
     */
        #define UART_Dm_INTR_NONE      (uint16)(0x0000u)
        #define UART_Dm_INTR_RISING    (uint16)(0x0001u)
        #define UART_Dm_INTR_FALLING   (uint16)(0x0002u)
        #define UART_Dm_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define UART_Dm_INTR_MASK      (0x01u) 
#endif /* (UART_Dm__INTSTAT) */
...
/* SIO registers */
#if defined(UART_Dm__SIO_CFG)
    #define UART_Dm_SIO_HYST_EN        (* (reg8 *) UART_Dm__SIO_HYST_EN)
    #define UART_Dm_SIO_REG_HIFREQ     (* (reg8 *) UART_Dm__SIO_REG_HIFREQ)
    #define UART_Dm_SIO_CFG            (* (reg8 *) UART_Dm__SIO_CFG)
    #define UART_Dm_SIO_DIFF           (* (reg8 *) UART_Dm__SIO_DIFF)
#endif /* (UART_Dm__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define UART_Dm_0_INTTYPE_REG 		(* (reg8 *) UART_Dm__0__INTTYPE)
#endif /* (UART_Dm__INTSTAT) */

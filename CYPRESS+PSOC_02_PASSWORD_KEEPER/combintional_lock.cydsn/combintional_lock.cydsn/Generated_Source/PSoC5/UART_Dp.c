...
*
* \funcusage
*  \snippet UART_Dp_SUT.c usage_UART_Dp_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet UART_Dp_SUT.c usage_UART_Dp_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet UART_Dp_SUT.c usage_UART_Dp_Read  
*******************************************************************************/
...
* preferred UART_Dp_Read() API because the 
* UART_Dp_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet UART_Dp_SUT.c usage_UART_Dp_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: UART_Dp_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use UART_Dp_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - UART_Dp_0_INTR       (First pin in the list)
    *  - UART_Dp_1_INTR       (Second pin in the list)
    *  - ...
    *  - UART_Dp_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet UART_Dp_SUT.c usage_UART_Dp_SetInterruptMode
    *******************************************************************************/
    void UART_Dp_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & UART_Dp_0_INTR) != 0u) 
		{ 
			 UART_Dp_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet UART_Dp_SUT.c usage_UART_Dp_ClearInterrupt
    *******************************************************************************/
